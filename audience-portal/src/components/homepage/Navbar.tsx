    ...
    <header className="fixed top-0 w-full z-50 bg-white/80 dark:bg-[#0A0910]/80 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800/40">
      <div className="flex justify-between items-center px-gutter max-w-container-max mx-auto h-16">
        <div className="flex items-center gap-3">
          <img alt="AcadSphere Logo" className="h-8 w-8 object-contain" src="/Acadshpere%20website%20logo.png"/>
        ...
        <nav className="hidden md:flex items-center gap-8">
          <a className="font-label-md text-label-md text-[#7C3AED] dark:text-[#9c82ff] font-bold transition-colors duration-200" href="/">Home</a>
          <a className="font-label-md text-label-md text-zinc-500 dark:text-zinc-400 hover:text-[#7C3AED] dark:hover:text-[#9c82ff] transition-colors duration-200" href="/privacy">Privacy</a>
        </nav>
